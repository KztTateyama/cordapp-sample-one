...
import com.template.contracts.SampleContract.Commands.Transfer;
...
// * Initiator flow *
// ******************
public class TransferSampleFlow {
    ...
    public static class InitiatorFlow extends FlowLogic<SignedTransaction> {
       ...
       public SignedTransaction call() throws FlowException {
           ...
           SampleState inputStateToChange = (SampleState) inputStateAndRefToChange.getState().getData();
           ...
           listOfRequiredSigners.add(holder.getOwningKey());
           ...
           tb.addOutputState(inputStateToChange.withNewHolder(holder), SampleContract.IOU_CONTRACT_ID);
           tb.addCommand(command);

           // 6. Ensure that this flow is being executed by the current lender.
           if (!inputStateToChange.holder.getOwningKey().equals(getOurIdentity().getOwningKey())) {
           ...
           sessions.add(initiateFlow(holder));
     ...
     */
    @InitiatedBy(TransferSampleFlow.InitiatorFlow.class)
            ...
            class SignTxFlow extends SignTransactionFlow {
                ...
                protected void checkTransaction(SignedTransaction stx) {
                    requireThat(require -> {
                        ...
                        require.using("This must be an IOU transaction", output instanceof SampleState);
                        return null;
                    });
